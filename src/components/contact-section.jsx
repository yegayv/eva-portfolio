...
const ContactSection = () => {
  return (
    <section id='contact' className='bg-white rounded-t-full'>
      {/* Contact Us */}
      <div className="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
        <div className="max-w-xl mx-auto">
          <div className="text-center">
            <h1 className=" mt-8 text-3xl font-bold text-gray-800 sm:text-4xl dark:text-white">
              Contact us
            </h1>
        ...
        <div className="mt-12 max-w-lg mx-auto">
          {/* Card */}
          <div className="flex flex-col border-2 rounded-xl p-4 sm:p-6 lg:p-8 dark:border-gray-700">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 lg:gap-6">
                  <div>
                    ...
                    <input
                      ...
                      className="py-3 px-4 block w-full border-gray-200 border-[2px] rounded-md text-sm focus:border-blue-500 focus:ring-blue-500 dark:bg-slate-900 dark:border-gray-700 dark:text-gray-400"
                    />
                  </div>
                  <div>
                    <label
